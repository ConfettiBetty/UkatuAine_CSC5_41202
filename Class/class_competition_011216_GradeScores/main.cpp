/* 
    File:   Class Competition Jan 12, 2016
    Author: Aine Ukatu, Anthony Tadesse
    Created on January 12, 2016, 10:46 AM
    Purpose:  1 of 4 Competition Problems
 Which statement type does it best? Ternary, Independent if, Dependent if, switch?
 */
...
int main(int argc, char** argv) {
    ...
    unsigned char gradeA=90;  //Grade breakdown
    unsigned char gradeB=80;
    unsigned char gradeC=70;
    unsigned char gradeD=60;
    unsigned char gradeF=59;
    unsigned short score1; //Score
    ...
    cout<<(score1<=gradeF? "Your grade is F":" ")<<endl;
    cout<<(score1<gradeC? "Your grade is D":" ")<<endl;
    cout<<(score1<gradeB? "Your grade is C":" ")<<endl;
    cout<<(score1<gradeA? "Your grade is B":" ")<<endl;
    cout<<(score1>=gradeA? "Your grade is A":" ")<<endl;
