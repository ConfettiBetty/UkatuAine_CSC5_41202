...
int main(int argc, char** argv) {
    ...
    unsigned short regHrs=8;
    unsigned short minHrs=5;
    unsigned short hrsWkd; 
    ...
    cout<<(hrsWkd<=minHrs? "Your bill is $4000":" ")<<endl;
    cout<<(hrsWkd<=regHrs? "Your bill is $"hours*800:" ")<<endl;
    cout<<(hrsWkd>regHrs? "Your bill is $"hours*1200:" ")<<endl;
