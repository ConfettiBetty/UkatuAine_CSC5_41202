/* 
    ...
    Created on January 26, 2016, 11:16 AM
    Purpose:  Midterm, due Friday January 29, 2016
 */
    ...
    do{
        ...
        switch(nSoltn){
            case 1:{
                ...
                cout<<endl<<"Solution to problem 1 on midterm"<<endl;
                cout<<endl<<"Type a number, print an X"<<endl<<endl;
                //Declare variables
            ...
            case 2:{
                //The problem to solve
                cout<<endl<<"Solution to problem 2 on midterm"<<endl;
                cout<<endl<<"Read four digits, print asterix sequence "<<endl<<endl;
            ...
            case 3:{
                //The problem to solve
                cout<<endl<<"Solution to problem 3 on midterm"<<endl;
                ...
                //Output the results
                cout<<"The exact  value of PI="<<endl;
            ...
            case 4:{
                //The problem to solve
                cout<<endl<<"Solution to problem 4 on midterm"<<endl;
                cout<<endl<<"How much can you save?"<<endl<<endl;
            ...
            case 5:{
                //The problem to solve
                cout<<endl<<"Solution to problem 5 on midterm"<<endl;
                cout<<endl<<"Paying Employees"<<endl<<endl;
            ...
            case 6:{
                //The problem to solve
                cout<<endl<<"Solution to problem 6 on midterm"<<endl;
                cout<<endl<<"Sequence"<<endl<<endl;
